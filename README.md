...
- givenSteadilyIncreasingCurrentRange_whenCharging_thenObtainMostOftenEncounteredValue the name of a **passing** test
- givenArbitraryCurrentRange_whenCharging_thenObtainMostOftenEncounteredValue the name of a **failing** test
